...
- [备忘学习文档study](#study)
    ...
    - [chrome浏览器](#chrome)
        - [常用快捷键hotkey](#hotkey)
        - [查看事件监听listener](#listener)
        - [调试模式找不到ajax请求的js](#ajaxjs)
        - [模拟网速慢的情况low net speed](#low-net-speed)
        - [小于12px的字体不渲染的解决方案](#12px)
        - [添加受信任的https网站](#https)
    - [http](#http)
        - [跨域 CORS](#cors)
        - [浏览器缓存机制cache](#cache)
    - [html](#html)
        - [a标签click不触发转跳](#aclick)
        - [a标签热键](#a)
        - [事件阶段event](#event)
    - [javascript](#javascript)
        - [三种声明方式的区别decare](#decare)
        - [jquery动态事件绑定](#jquery)
        - [JS打开新窗口的2种方式](#js2)
        - [javascript 函数call apply区别](#javascript-call-apply)
        - [javascript 正则表达式可视化](#javascript)
        - [字节序-大小端 endian](#endian)
    - [nodejs](#nodejs)
    - [mongo](#mongo)
        - [CAP理论](#cap)
        - [安装步骤install](#install)
        - [备份与恢复 backup and restore](#backup-and-restore)
    - [freemarker 语法](#freemarker)
    - [JAVA](#java)
        - [logback配置文件中additivity的作用](#logbackadditivity)
        - [ocr识别（图片转文字）](#ocr)
        - [线程 thread](#thread)
        - [引用 reference](#reference)
        - [finally和return执行顺序](#finallyreturn)
        - [java中的常见错误](#java)
    - [git命令](#git)
        - [解决git pull push每次都需要输入密码问题](#git-pull-push)
        - [gitignore文件用法](#gitignore)
        - [查看命令语法 get help](#get-help)
        - [日志命令 get log](#get-log)
    - [markdown](#markdown)
        - [code 语法](#code)
        - [转ppt方案](#ppt)
        - [在线转表格 Tables](#tables)
    ...
    - [mysql](#mysql)
    - [oracle](#oracle)
        - [oracle存储过程 procedure =>](#oracle-procedure)
    - [lucene](#lucene)
    - [maven](#maven)
    - [jenkins](#jenkins)
        - [ant启动报错 'ant.bat' 不是内部或外部命令，也不是可运行的程序](#ant-antbat)
    - [SpringMVC](#springmvc)
    - [Total Commander](#total-commander)
        - [设置关闭按钮最小化tc minimize](#tc-minimize)
        - [快捷键 tc shortcuts](#tc-shortcuts)
    - [window](#window)
        - [path环境变量命令](#path)
        - [cmd中复制粘贴](#cmd)
        - [Win7不按Shift，直接右键显示“在此处打开命令窗口(W)”](#win7shiftw)
        - [win10 multi desktop多桌面快捷键](#win10-multi-desktop)
        - [windows service 查找服务名](#windows-service)
        - [windows win+r cmd 常用命令](#windows-winr-cmd)
        - [windows清除网上邻居帐号](#windows)
        - [windows kill 进程命令](#windows-kill)
        - [windows 隐藏盘符](#windows)
        - [windows添加管理单元 如管理受信证书](#windows)
        - [真正的管理员 administrator](#administrator)
        - [vscode用法](#vscode)
        - [系统变量 environment](#environment)
        - [windows right click 修改右键位置](#windows-right-click)

## idea

### maven控制台中文乱码

> Settings->maven->runner   设置VMoptions: -Dfile.encoding=GB2312
...
1. 放弃本地修改，直接覆盖之 git reset --hardgit pull  
...
credential 凭据  
>>>>>>> 59fe6170489b7d0f39827ad7f724cdfb1ee758cd
